  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      if (response.status) {
        ...
        console.log('THE RESPONSE FROM IDENTIFY ==> ' + JSON.stringify(response.data))
        ...
        // const specie = response.data['class_name'];
  ...
  <path d="M12 2a10 10 0 0110 10 10 10 0 01-10 10 10 10 0 01-10-10A10 10 0 0112 2z" />
        ...
        <div className="flex flex-wrap w-full justify-center -mx-3 mb-3">
          ...
          <div className='flex gap-1 mt-5 justify-between'>
                          ...
                          <Button onClick={handleUpload} className="bg-green-500 text-white py-2 px-4 rounded text-center hover:bg-green-500 hover:font-extrabold" disabled={!selectedFile || isLoading}>Identify</Button>
                        ...
                        {clearButton ? (
                            <ul className='text-center'>
                                ...
                                {predictions?.map((pred: PredictionsType, i: any) => (
                        ...
                        {/* {probability && specie && specieClassID ? (
                          <div className="flex justify-center gap-5 mt-4">
                            <div className="mr-4"> */}
                             
                              {/* <p className="mb-2 flex justify-center font-bold">{specie}</p> */}
                              {/* <p className="mb-2 flex justify-center font-bold">{specieClassID}</p> */}
                              {/* <p className="mb-2 flex justify-center font-bold">{probability}% Probability</p> */}
